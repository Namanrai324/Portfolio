...
export function PixelatedImageTrail({
  ...
  useEffect(() => {
    ...
    const parent = container.parentElement || container;
    parent.addEventListener("pointerenter", updatePointer as any);
    parent.addEventListener("pointermove", updatePointer as any);
    parent.addEventListener("pointerleave", handlePointerLeave);
    parent.addEventListener("touchstart", updatePointer as any, { passive: true });
    parent.addEventListener("touchmove", updatePointer as any, { passive: true });
    parent.addEventListener("touchend", handlePointerLeave);
    animationFrameRef.current = requestAnimationFrame(render);

    return () => {
      parent.removeEventListener("pointerenter", updatePointer as any);
      parent.removeEventListener("pointermove", updatePointer as any);
      parent.removeEventListener("pointerleave", handlePointerLeave);
      parent.removeEventListener("touchstart", updatePointer as any);
      parent.removeEventListener("touchmove", updatePointer as any);
