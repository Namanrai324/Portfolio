...
const parseFramerColor = (color: any): string => {
    if (color === 'red-white') return 'red-white';
...
function __OriginkitBase_MagicTextReveal({
...
export default function DustTextReveal(props: MagicTextRevealProps) {
  const defaultProps = {
    density: 10,
    playMode: "hover" as const
  };
  return <__OriginkitBase_MagicTextReveal {...defaultProps} {...props} />;
}
