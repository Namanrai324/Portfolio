...
function __OriginkitBase_ParticleText(props: Props) {
    ...
    useEffect(() => {
        ...
        const sampleText = () => {
            ...
            const fontFamily = props.fontFamily || 'Impact, "Kanit", sans-serif'
            ...
            const downsample =
                candidates > 40000 ? Math.ceil(candidates / 40000) : 1
            const allocCount = Math.min(candidates, 40000)
    ...
    return (
        <div
            ref={containerRef}
            className="originkit-particle-text"
            style={{
                position: "relative",
                width: "100%",
                height: "100%",
...
export default function PixelDrift(props: Props) {
